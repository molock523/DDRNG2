...
OffFocusedCommand=function(self)
        SOUND:PlayOnce(THEME:GetPathS("","Announcer/ScreenSelectStyle_CommentSingle"))
end;
};
t[#t+1] = Def.ActorFrame {
    ...
    LoadActor(THEME:GetPathG("","_machine/pads_overlay.png"))..{
        InitCommand=cmd(vertalign,bottom;addy,100;diffusealpha,1;cropleft,0.5);
    ...
    Def.Sprite{ 
        InitCommand=cmd(vertalign,bottom;addy,50);
    ...
    LoadFont("Common Normal")..{
        Text="Play by yourself\nusing one standard arrow dance pad";
