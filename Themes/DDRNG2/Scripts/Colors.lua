function UIPanelColor()
    if UIColor() == "Light" then return "#eaeaea"
    else return "#2e2e2e"
    end
end
...
function GroupColour(group)
	local group_colours= {
		...
		["DanceDanceRevolution SuperNOVA"]= "#ff5353",
		...
		["DDR 2014"]= "#33FF99",
        ["DDR A"]= "#002b68",        
		["DDR Next Generation"]= "#ff96d4",
        ["DDR Next Generation 2"]= "#e88dbd",        
	}
	return group_colours[group] or "#eaeaea"
end

function CourseColour(group)
    local group_colours={
        ["Next Generation"]= "#e88dbd",
    }
    return group_colours[group] or "2e2e2e"
end
